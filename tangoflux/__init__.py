...
class TangoFluxInference:
    ...
    def generate(self, prompt, steps=25, duration=10, guidance_scale=4.5, prefix=None):
        """
        If prefix is not None, it must be a latents tensor shaped [batch_size, prefix_len, 64].
        We'll pass it to 'inference_flow' so it can continue from that prefix.
        """
        with torch.no_grad():
